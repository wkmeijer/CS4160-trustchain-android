...
public interface NetworkCommunicationListener {
    ...
    void updateWan(MessageProto.Message message) throws MessageException;
    ...
    void handleIntroductionResponse(PeerAppToApp peer, MessageProto.IntroductionResponse response);
